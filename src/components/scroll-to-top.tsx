    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.95 }}
          className="group/scroll fixed bottom-6 right-6 z-[90] flex size-11 items-center justify-center overflow-hidden rounded-full text-primary-foreground shadow-[0_8px_24px_-6px_oklch(0.48_0.22_260/0.5)] transition-shadow hover:shadow-[0_12px_32px_-6px_oklch(0.48_0.22_260/0.65)] sm:size-12"
        >
          {/* Fond gradient */}
          <span
