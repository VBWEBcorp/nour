  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(oklch(0.55 0.03 258 / 0.15) 1px, transparent 1px)',
...
function Orb({
  ...
  const colors = {
    violet: 'oklch(0.4 0.07 258 / 0.4)',
    indigo: 'oklch(0.4 0.07 258 / 0.35)',
    cyan: 'oklch(0.8 0.05 255 / 0.3)',
    rose: 'oklch(0.5 0.06 258 / 0.25)',
  }
  return (
    <div
...
function Blob({
  ...
  const colors = {
    violet: 'oklch(0.4 0.07 258)',
    indigo: 'oklch(0.4 0.07 258)',
    cyan: 'oklch(0.8 0.05 255)',
  }
  return (
    <svg
